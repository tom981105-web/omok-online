...
// Patch 12.0 - 장신구 세트 효과 + 칭호 데이터
var ACCESSORY_SETS={
  kraken:{
    id:'kraken',name:'🐙 크라켄 세트',
    items:['kraken_ring','kraken_eye_necklace','kraken_heart_relic'],
    twoText:'2세트: 보스 딜 +10%',
    threeText:'3세트: 먹물 면역',
    twoEffects:{bossDamage:.10},
    immunePattern:'ink'
  },
  leviathan:{
    id:'leviathan',name:'🐋 레비아탄 세트',
    items:['storm_compass','leviathan_pearl','leviathan_scale_relic'],
    twoText:'2세트: 대형 물고기 확률 +5%',
    threeText:'3세트: 폭풍 면역',
    twoEffects:{bigFishBonus:.05},
    immunePattern:'storm'
  },
  phoenix:{
    id:'phoenix',name:'🐉 심해룡 세트',
    items:['ancient_core','abyss_gem','dragon_fang_relic'],
    twoText:'2세트: 전설 확률 +2%',
    threeText:'3세트: 전자기 교란 면역',
    twoEffects:{legendBonus:2},
    immunePattern:'reverse'
  }
};

var PLAYER_TITLES={
  rookie:{id:'rookie',name:'초보 낚시꾼',desc:'처음부터 사용할 수 있는 기본 칭호입니다.',condition:'기본 지급'},
  river_angler:{id:'river_angler',name:'강태공',desc:'물고기를 30마리 이상 잡은 낚시꾼입니다.',condition:'누적 30마리'},
  veteran_angler:{id:'veteran_angler',name:'숙련 낚시꾼',desc:'물고기를 100마리 이상 잡은 숙련자입니다.',condition:'누적 100마리'},
  legendary_collector:{id:'legendary_collector',name:'전설 수집가',desc:'도감 발견 수가 50종 이상인 수집가입니다.',condition:'도감 50종'},
  kraken_slayer:{id:'kraken_slayer',name:'크라켄 사냥꾼',desc:'크라켄 세트를 완성한 레이드 낚시꾼입니다.',condition:'크라켄 3세트'},
  leviathan_conqueror:{id:'leviathan_conqueror',name:'레비아탄 정복자',desc:'레비아탄 세트를 완성한 심해의 정복자입니다.',condition:'레비아탄 3세트'},
  abyss_lord:{id:'abyss_lord',name:'심해의 지배자',desc:'심해룡 세트를 완성한 최상위 레이드 낚시꾼입니다.',condition:'심해룡 3세트'},
  accessory_master:{id:'accessory_master',name:'장신구 수집가',desc:'장신구를 6종 이상 보유한 수집가입니다.',condition:'장신구 6종 보유'},
  enhance_master:{id:'enhance_master',name:'강화 장인',desc:'장신구를 +10까지 강화한 장인입니다.',condition:'장신구 +10 강화'}
};
