...
export function installBossModule(ctx){
  ...
  function getBossRushDifficulty(){
    ...
    const stormImmune=stormResist>=1;
    const stormMul=(hasRaidPattern('storm')&&!stormImmune)?(2.0-(0.7*stormResist)):1;
    ...
    const stormZonePenalty=(hasRaidPattern('storm')&&!stormImmune)?(0.70+(0.22*stormResist)):1;
