...
export function installBossModule(ctx){
  ...
  function getBossRushDifficulty(){
    ...
    const stormMul=hasRaidPattern('storm')?2.0:1;
    ...
    const stormZonePenalty=hasRaidPattern('storm')?0.70:1;
  ...
  function triggerBossPattern(){
    ...
    for(const p of picked){
      const duration=(cfg.patternDuration&&cfg.patternDuration[p])||(p==='ink'?2.0:3.0);
